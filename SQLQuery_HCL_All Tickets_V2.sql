...
SELECT
  ...
  Where
       A.[Task_Type] = 'Incident' and A.[Assignment_Group] in ('Supply Operations-Scheduling and Ticketing','Supply Operations-Inventory Management','Europe Business Operations','Fuels IT T&A MSP') 
	   or A.[Task_Type] = 'Catalog task' and A.[Assignment_Group] in ('Supply Operations-Scheduling and Ticketing','Supply Operations-Inventory Management','Europe Business Operations','Fuels IT T&A MSP')
